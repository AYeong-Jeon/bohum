            ...
            <div class="col-md-6">
               <c:forEach var="gender" items="${genderArr }" varStatus="status">
                  <label class="radio-inline"> <input type="radio"
                     name="gender" value="${memberDetailBean.gender}"
                     <c:if test="${gender==memberDetailBean.gender}">checked</c:if>>${gender}&nbsp&nbsp</label>
               </c:forEach>
            </div>
            <div class="col-md-2">
