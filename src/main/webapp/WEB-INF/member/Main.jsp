...
<main class="container">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
      <h1>늘어나는 의료비 부담, 이제 걱정하지 마세요.</h1>
      <p class="lead my-3"><a href="">나에게 꼭 맞는 보험 추천</a></p>
  </div>
      ...
      <div class="position-sticky" style="top: 2rem;">
        ...
        <div class="p-4">
          ...
          <ol class="list-unstyled mb-0">
            <li><a href="#">ai 추천 보험</a></li>
            <li><a href="#">내 보험료 계산</a></li>
            <li><a href="#">보험 가입 팁</a></li>
          </ol>
        </div>
